 	...
 	$.fn.CountdownGampang = function(options, callback) {
 		...
 		function prepareTemplate() {
 			element.append('<div class="ClassyCountdown-wrapper">' +
 				...
 				'<input type="text" />' +
 				'<span class="ClassyCountdown-value"><span></span> <div></div></span>' +
 				'</div>' +
 				...
 				return {
 					...
 					style: {
 						...
 						days: {
 							...
 							textCSS: 'font-weight:600;color:#17A2B8;'
 						},
 						hours: {
 							gauge: {
 								thickness: 0.2,
 							...
 							textCSS: 'font-weight:600;color:#8019B0;'
 						},
 						minutes: {
 							gauge: {
 								thickness: 0.2,
 							...
 							textCSS: 'font-weight:600;color:#FF8000;'
 						},
 						seconds: {
 							gauge: {
 								thickness: 0.2,
 							...
 							textCSS: 'font-weight:600;color:#1D4C8C;'
 						}
 					}
 				};
