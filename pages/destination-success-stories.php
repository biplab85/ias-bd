...
<body>
    ...
    <section class="destination-universities-area success-story py-80">
        <div class="container">
            <div class="row card-container m-0">
                <div class="col-md-4">
                    <div class="card mb-30 mb-md-60">
                        <div class="banner">
                            <img class="banner-bg" src="../assets/image/success-story/bg.png" alt="" title="">
                            <img class="auth" src="../assets/image/success-story/02.jpg" alt="" title="">
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-container text-center">
                        <a class="ias-btn" href="#">All Success Stories</a>
                    </div>
                </div>
            </div>
        </div>
