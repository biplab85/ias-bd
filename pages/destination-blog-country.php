...
<body>
    ...
    <section class="blog-container destination-blog-country-area my-0" style="background-image: url(../assets/image/study-destinations/country-blog-bg.svg)">
        <div class="container py-80">
            <div class="row card-container my-0">
                <div class="col-md-4">
                    <div class="card">
                        <div class="banner">
                            <img class="banner-bg" src="../assets/image/blog/bg.png" alt="" title="">
                            <img class="auth" src="../assets/image/blog/01.jpg" alt="" title="">
                        </div>

                        <div class="description">
                            <div class="uesr-info">
                                <div class="name">
                                    <h3>Lorem Ipsum Dolor Sit Amet Dummy Text</h3>
                                </div>
                                <div class="share">
                                    <h4>
                                        <i class="flag">
                                            <img class="auth" src="../assets/image/blog/flag.svg" alt="" title="">
                                        </i>
                                        <span>
                                            <img class="auth" src="../assets/image/blog/calendar.svg" alt="" title="">
                                            Jun 02, 2022
                                        </span>
                                    </h4>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="banner">
                            <img class="banner-bg" src="../assets/image/blog/bg.png" alt="" title="">
                            <img class="auth" src="../assets/image/blog/02.jpg" alt="" title="">
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="banner">
                            <img class="banner-bg" src="../assets/image/blog/bg.png" alt="" title="">
                            <img class="auth" src="../assets/image/blog/03.jpg" alt="" title="">
                        </div>
            ...
            <div class="row mt-60">
                <div class="col-md-12">
                    <div class="btn-container text-center">
                        <a class="ias-btn" href="#">See All Blogs</a>
                    </div>
                </div>
            </div>
        </div>
