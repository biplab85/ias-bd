...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarFilter">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Application Steps</a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="destination-application-steps-area py-80 py-lg-120">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h2 class="page-title text-uppercase mb-30">APPLICATION STEPS</h2>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    <p class="text-light-blue mb-30"><b>For Much Better Options</b></p>

                    <div class="btn-container">
                        <a class="ias-btn" href="#">Contact Us Now</a>
                    </div>
                </div>

                <div class="col-md-6">
                    <img src="../assets/image/study-destinations/application-steps/featured-img.png" alt="featured" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
