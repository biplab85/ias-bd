...
<body>
    ...
    <section class="ias-header h-345 mb-0 backgorund-center backgorund-repeat" style="background-image: url(../assets/image/success-story/success-story-details.svg);">
        <div class="container">
            <div class="col-md-12">
                <div class="content-wrapper text-center">
                    <div class="content-header-section white text-center">
                        <h3 class="title with-bg d-inline-block mx-auto">SAMIA RAHMAN</h3>
                    </div>
    ...
    <div class="success-container">
        <section class="success-story-details-container">
