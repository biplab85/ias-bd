<section class="make-incomparable">
    <div class="content-header-section text-center">
        <h3 class="title">What makes us incomparable?</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12  wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s">
                <div class="incomparable-list-wrapper">
                    <div class="list">
                        <div class="incomparable-list">
                            ...
                            <div class="short-details">
                                <h4>Young</h4>
                                <p>
                                    We believe we are young & the power of youth is the common wealth of the entire world.
                                </p>
                            </div>
                        </div>
                        <div class="incomparable-list">
